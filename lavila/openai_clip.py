...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = '/mnt/graphics_ssd/nimble/users/annakukleva/llm/clip/'):
    """Load a CLIP model
    Parameters
    ----------
    name : str
